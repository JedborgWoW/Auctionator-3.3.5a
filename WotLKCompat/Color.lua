...
EnsureColor("LIGHTGRAY_FONT_COLOR", 0.7, 0.7, 0.7)
EnsureColor("BLUE_FONT_COLOR", 0.3, 0.4, 1.0)
EnsureColor("LIGHTBLUE_FONT_COLOR", 0.6, 0.8, 1.0)
EnsureColor("ORANGE_FONT_COLOR", 1.0, 0.5, 0.25)
